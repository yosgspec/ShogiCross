(async function(){
	...
	function player4(){
		...
		board.putNewPiece("士", 6, 6);
		board.putNewPiece("車", 6, 5);
		board.putNewPiece("卆", 7, 5);
		board.putNewPiece("象", 7, 6, 90);
		board.putNewPiece("包", 8, 6, 90);
		board.putNewPiece("卆", 8, 7, 90);
		board.putNewPiece("馭", 8, 8, 90);
		board.putNewPiece("楚", 7, 7, 180);
		board.putNewPiece("車", 7, 8, 180);
		board.putNewPiece("卆", 6, 8, 180);
		board.putNewPiece("象", 6, 7, 270);
		board.putNewPiece("包", 5, 7, 270);
		board.putNewPiece("卆", 5, 6, 270);
		board.putNewPiece("馭", 5, 5, 270);
		board.draw();
		textareaMini.value = board.outputText(true);
		textarea.value = board.outputText();
	}
