...
function me(p) {
  Object.assign(N, p.canvasFont), Object.assign(pe, p.gameSoft), Object.assign(K, p.games), Object.assign(z, p.boards), Object.assign(T, p.panels), Object.assign(D, p.pieces), Object.assign(se, p.pieceRange), Object.assign(J, p.pieceCost);
}
me(Se);
function ue(p) {
...
class C {
  ...
  * @type {Object<string, number>}
  ...
  drawImage() {
    if (!this.ctx) return;
    const { ctx: e, size: t, deg: a } = this, n = this.imgSrc[a][this.displayPtn] ?? this.imgSrc[0][this.displayPtn], s = j.images[n];
    if (!s) return;
...
class I {
  ...
  dropPiece(e, t = {}) {
    const { board: a } = this;
    if (!(e instanceof R) || a.moveMode === "viewOnly" || e.hasAttr("keepOut")) return;
      ...
      for (const [w, { child: b = [] } = {}] of ye)
        for (let k = 0; k < u.length; k++)
          for (let E = 0; E < u[k].length; E++) {
            const [v, P] = [E + t - W, k + a - x];
            !o(v, P) || !c(f, v, P, m) || u[k][E] !== w || S(u, b, !1, W, x) || h(m, v, P);
          }
  }
        ...
        for (let M = x - 1; M <= x + 1; M++)
          for (let L = W - 1; L <= W + 1; L++) {
            ...
            for (let _ = t, ee = a; ; ) {
              ...
              if (!o(F, $) || !P && H === 0) break;
              const U = Q === 0;
              U && c(f, F, $, m, U) ? (H--, h(m, F, $)) : E < 1 && H--;
              const te = s[$][F];
              if (te.piece && (Q--, U || l(te)))
                break;
            }
          }
      }
  ...
  async playTurn() {
    ...
    e.field.flat().forEach((i) => {
      if (i.piece && i.piece.deg === t.deg) {
        const r = i, o = O(e, r.piece, r.pX, r.pY);
...
const xe = Object.keys(C.degChars), ae = () => ({ pX: null, pY: null, pieceId: null });
class q {
  constructor() {
    this.degs = {}, xe.forEach((e) => this.degs[e] = ae());
  }
  /** アンパッサン情報をクリア
...
class V {
  ...
  constructor(e, t) {
    ...
    if (this.option = t, this.isHeadless = W, this.name = a, this.variant = n, this.url = s, this.desc = i, this.displayDeg = 0, this.ctx = null, this.canvas = null, this.pieces = C.getPieces(null, {
      ...
      useRankSize: B,
      isDrawShadow: u
    }), !z[r]) throw Error(`playBoard=${r}, Unknown board name.`);
    if (Object.assign(this, z[r]), ![2, 4].includes(l)) throw Error(`players=${l}, players need 2 or 4.`);
    this.playerLen = l, this.left = d, this.top = c, this.panelWidth = S, this.panelHeight = h, this.borderWidth = m, this.pieceSize = g, this.canvasBackgroundColor = f, this.field = this.field.map(
      (y, w) => [...y].map((b, k) => {
        ...
        return new R(null, b, E, v, S, h, k, w, m);
      })
    ...
    this.width = this.panelWidth * (this.xLen + 1), this.height = this.panelHeight * (this.yLen + 1), this.right = d + this.width, this.bottom = c + this.height, this.stand = new I(this), this.moveMode = x, this.record = new fe(this), this.enPassant = new q();
  }
  /** ゲームを実行する
   * @param {HTMLCanvasElement} canvas - Canvas要素
...
`).replace(/　/g, "・").trim().split(/\n/).map(
   ...
   */
  simpleMovePiece(e, t) {
    !(e instanceof R) || !(t instanceof R) || (t.piece = e.piece, t.piece.isMoved = !0, e.piece = null);
  }
  /** 駒を移動
   * @param {Panel} fromPanel - 移動元のマス目
   * @param {Panel} toPanel - 選択中のマス目
  ...
  const { canvas: s } = p, i = async (c, S, h = () => {
    ...
    e = !0, await i(
      ...
      (S, h, g) => {
        ...
        B && S.checkRangeMouse(h, g) && (c.preventDefault(), B.isSelected = !0, a = S, O(p, B, u, m));
      },
      (S, h) => {
...
class Z extends V {
  ...
  constructor(e, t) {
    ...
    let B = null, u = null;
    if (!r) {
      B = N.importAsync(), u = j.importAsync(), this.canvas = e, this.ctx = e.getContext("2d"), this.ctx.clearRect(0, 0, e.width, e.height), this.overlay = new Oe(this.canvas, l), this.#a = new ve();
    ...
    }), u.then(() => this.draw()), this.draw()), this.isGameEnd = !1, this.onDrawed = c, this.onTurnEnd = S, this.onGameOver = h, this.onGameEnd = g, r || (this.#e = Ne(this)), d && (this.#t = this.makeUIControl(), this.#t.add());
  }
  /** 操作パネルを構築
...
class $e extends Z {
  ...
  constructor(e, t) {
    ...
    this.players.forEach((o) => {
      ...
      try {
        ...
        switch (l.type) {
          ...
          case "readyOnline":
            ...
            d && (d.isLocal = !0, this[X].rotateField(d.deg), this.stand.rotate(d.deg), this.displayDeg = d.deg, this.autoDrawing && this.draw());
            break;
          // 駒が動いた場合
          case "move":
      ...
      console.error("WebSocket error:", o), this[X].dialog?.show("接続エラー", "サーバーとの接続でエラーが発生しました。");
    };
    const i = this;
    class r extends I {
      /** 持ち駒からボード上に配置する
  ...
  async moveRivalPiece({ from: e, to: t, playerDeg: a, promoChar: n }) {
    ...
    ), this.simpleMovePiece(r, o), await this.promoPiece(r, o, !!n, !1, !0, n), this.autoDrawing && this.draw(), this[X].emitGameOver();
  }
  /**
   * リモートからの打駒を盤面に適用する
   * @param {Object} message
