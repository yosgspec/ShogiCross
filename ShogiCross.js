...
class _ extends I {
  ...
  constructor(e, t) {
    ...
    let h = null, B = null;
    if (!r) {
      h = O.importAsync(), B = j.importAsync(), this.canvas = e, this.ctx = e.getContext("2d"), this.ctx.clearRect(0, 0, e.width, e.height), this.overlay = new Te(this.canvas, l), this.dialog = new je();
    ...
    this.isGameEnd = !1, this.onDrawed = S, this.onTurnEnd = u, this.onGameOver = f, this.onGameEnd = y, r || (this.#e = $e(this)), d && (this.makeUIControl(d, c), this.#t.add()), this.autoDrawing = o, o && (h.then(async () => {
