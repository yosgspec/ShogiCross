 ...
 * @type {CanvasFont}
 */
export const canvasFont = importJson("canvasFont");
 ...
 */
export const gameSoft = importJson("gameSoft");
 ...
 */
export const games = importJson("games");
	 ...
	 */
export const boards = importJson("boards");
 ...
 */
export const panels = importJson("panels");
 ...
 */
export const pieces = importJson("pieces");
 ...
 */
export const pieceRange = importJson("pieceRange");

/**
 * 駒の価値
 * @type {Object<string, number>}
 */
export const pieceCost = importJson("pieceCost");
