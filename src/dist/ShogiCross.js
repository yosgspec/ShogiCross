  ...
  constructor(e, t, a = {}) {
    ...
    try {
      Object.entries(this.range).forEach(([d, c]) => {
        Array.isArray(c) || (this.range[d] = ae[c].map((m) => [...m]));
      });
    } catch (d) {
...
function $(S, e, t, a) {
  ...
  function c(p, g, B, W = "", w = !0) {
    ...
    const k = s[B][g];
    return !k || l(k) || d(k) || W === "enPassant" && !r.isTarget(k, e) || e.hasAttr("inPalace") && !k.hasAttr("palace") || W.indexOf("palace") === 0 && !(k.hasAttr(W) && s[a][t].hasAttr(W)) || e.hasAttr("unCrossRiver") && n - (0 | n / 2) <= S.getRow(g, B, e.deg) ? !1 : p ? s[B][g].piece ? w ? e.deg !== s[B][g].piece.deg : !0 : !1 : !s[B][g].piece;
  }
  ...
  const { canvas: s } = S, n = (d, c, m = () => {
    ...
    e = !0, n(
      ...
      (c, m, u) => {
        ...
        h && c.checkRangeMouse(m, u) && (d.preventDefault(), h.isSelected = !0, a = c, $(S, h, y, p));
      },
      (c, m) => {
...
const Ae = Object.keys(C.degChars), te = () => ({
  panel: null,
  piece: null
});
class Ce {
  constructor() {
    this.degs = {}, Ae.forEach((e) => this.degs[e] = te());
  }
  /** アンパッサン情報をクリア
...
class Z {
  ...
  constructor(e, t) {
    ...
    for (let f = 0; f < l; f++) {
      ...
      if (v.cpu = new we(this, v), this.players.set(N, v), !!v.gameName)
        try {
    ...
    if (this.width = this.panelWidth * (this.xLen + 1), this.height = this.panelHeight * (this.yLen + 1), this.right = h + this.width, this.bottom = y + this.height, this.stand = new _(this), !x) {
...
function xe(S) {
  Object.assign(P, S.canvasFont), Object.assign(oe, S.gameSoft), Object.assign(Q, S.games), Object.assign(q, S.boards), Object.assign(z, S.panels), Object.assign(U, S.pieces), Object.assign(ae, S.pieceRange), Object.assign(V, S.pieceCost);
}
xe(de);
const ke = () => [
  .../* @__PURE__ */ new Set([
