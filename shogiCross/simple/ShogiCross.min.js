...
┠${Array(e).fill("──").join("┼")}┨
`),i+this.field.map(e=>r+e.map(e=>""+(e.piece??e.toString(t))).join(a)+r).join(o)+s+this.stand.toString(t)}async downloadImage(t,e){await nt(this.canvas,t,e)}}export{q as Board,y as Piece,B as boards,A as canvasFont,z as canvasImage,pt as gameSoft,N as games};