...
export class Bod {
     ...
     * @type {Map<number, string>}
     */
    static "__#5@#deg2PieceRegexes": Map<number, string>;
    /** 駒の文字から角度表示
     * @type {Map<string, number>}
     */
    static "__#5@#pieceChar2Degs": Map<string, number>;
    /** 角度から持駒の表題表示
     * @type {Map<number, string>}
     */
     ...
     * @type {Map<string, number>}
     */
    static "__#5@#standTitle2Degs": Map<string, number>;
    static "__#5@#kanI": string[];
    static "__#5@#kanX": string[];
    /** 行/持駒用の数字表示(漢数字)
     * @param {number} num - 数字
     * @param {boolean} viewOne - 一を表示
     * @returns {string}
     */
    static "__#5@#num2Kan"(num: number, viewOne?: boolean): string;
    /** 行/持駒用の数字表示(漢数字)
     * @param {number} num - 数字
     * @param {boolean} emptyOne - 空文字を1とする
     * @returns {string}
     */
    static "__#5@#kan2Num"(kan: any, emptyOne?: boolean): string;
    /** 列用の数字表示(全角/2桁)
     * @param {number} num - 数字
     * @returns {string}
     */
    static "__#5@#num2Zen"(num: number): string;
    /** マス目の表示
     * @type {string}
     */
