...
export class Piece {
     ...
     */
    static getPieces(ctx: any, options?: {
        [x: string]: any;
    }): any;
    /** 文字列から駒を取得
     ...
     */
    constructor(ctx: any, piece: {
        [x: string]: any;
    }, { displayPtn, deg, size, useRankSize, isDrawShadow, isMoved }?: number);
    /** 駒の段階別価値を取得 */
    ...
    /** 将棋駒の外形パスを作成 */
    makePath(zoom: any): void;
    /** 駒の影を描写 */
    drawPieceShadow(zoom: any): void;
    /** 駒を描写 */
    drawPiece(): void;
    /** 駒にマスクを描写
     * @param {string} color - カラーエフェクトの色
